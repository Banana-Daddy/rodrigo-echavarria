...
// Query: "hero editorial magazine portrait" (also "hero warm earth heritage")
// Component: Hero 03 (Ali Imam) — oversized thin display with inline icons + side info chips.
// Date cached: 2026-05-13
// Use: Direction C — "Heredad" (heritage warm). Pattern borrowed:
//   stacked oversized type with inline iconography (Spanish word breaks),
//   tiny right-aligned info bullets, vertical "Award" tag fixed to side.
      ...
      <main className="relative pt-20 pb-20">
        <div className="flex relative gap-2 px-6 md:items-center w-full flex-col justify-center">
          <div className="md:flex gap-6 items-center">
            ...
            <h1 className="text-6xl md:text-7xl xl:text-[10rem] font-light leading-none tracking-wider">DIGITAL</h1>
          </div>
          <div className="md:flex gap-6 items-center">
